...
              variant="outline"
              size="icon"
              className="h-11 w-11 rounded-2xl border-slate-200 dark:border-slate-800 hover:bg-amber-500 hover:text-slate-950 transition-all"
            >
...
              <Building2 className="w-4 h-4 text-amber-500" /> Property
              Information
            </h3>
...
          <div className="space-y-4">
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2">
              <CreditCard className="w-4 h-4 text-amber-500" /> Transaction
              Metadata
            </h3>
...
                  <Hash className="w-3.5 h-3.5 text-amber-500" /> Transaction
                  ID:
                </span>
...
              <div className="flex justify-between items-center">
                <span className="text-slate-500 font-semibold flex items-center gap-1.5">
                  <Calendar className="w-3.5 h-3.5 text-amber-500" /> Payment
                  Date:
                </span>
                <span className="font-bold text-slate-800 dark:text-slate-200">
...
              <div className="flex justify-between items-center">
                <span className="text-slate-500 font-semibold flex items-center gap-1.5">
                  <CreditCard className="w-3.5 h-3.5 text-amber-500" /> Payment
                  Method:
                </span>
                <span className="font-bold text-slate-800 dark:text-slate-200">
...
                  Your payment is verified. Share your feedback for{" "}
...
                <Star className="w-4 h-4 mr-1.5 fill-slate-950" /> Write a
                Review
              </Button>
            </Link>
          </div>
...
            This is an electronically generated digital invoice verified by the
            platform. No physical signature required.
          </p>
        </div>
      </div>
    </div>
