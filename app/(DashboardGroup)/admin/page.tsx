...
// 🌟 Enterprise-grade Admin Features Data
const adminFeatures = [
  {
    title: "All Users & Agents",
    description: "Manage the comprehensive directory of general users, verified landlords, and authorized property agents.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Review pending property listing requests and manually approve them for public display on the platform.",
    icon: Building,
  ...
  },
  {
    ...
    description: "Assign new moderators or administrators, and strictly control their dashboard access and permissions.",
    icon: ShieldAlert,
  ...
  },
  {
    ...
    description: "Restrict access or permanently ban accounts of users and agents who violate platform policies or engage in spam.",
    icon: Ban,
  ...
  },
  {
    ...
    description: "Monitor real-time website traffic, active property listings, and other critical real estate market statistics.",
    icon: Activity,
  ...
  },
  {
    ...
    description: "Configure overarching system settings, appearance themes, and core operational parameters of the platform.",
    icon: Settings,
    color: "text-slate-700 dark:text-slate-400",
    bgGradient: "from-slate-500/15 to-slate-500/5 dark:from-slate-500/20 dark:to-slate-500/5",
    hoverBorder: "hover:border-slate-500/40 dark:hover:border-slate-500/50",
  },
];
    ...
    <div className="space-y-10 pb-12 font-sans transition-colors duration-300">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          >
            <Crown className="h-4 w-4 text-amber-600 dark:text-amber-400 drop-shadow-sm" />
            <span className="tracking-wide uppercase text-[11px]">Super Admin Access Verified</span>
          </motion.div>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed max-w-2xl font-medium">
            Manage the entire <span className="text-amber-600 dark:text-amber-400 font-semibold">UrbanNest</span> ecosystem, user controls, property approvals, and global configurations with enterprise-grade security.
          </p>
        </div>
      </motion.div>
