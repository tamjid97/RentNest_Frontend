        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-10">
            ...
            >
              ...
              <span className="tracking-widest uppercase text-[11px] md:text-xs">
                The Premier Luxury Rental Marketplace
              </span>
            </motion.div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[1.1] text-slate-900 dark:text-white drop-shadow-sm"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-14 leading-relaxed font-medium"
          >
            Discover verified luxury apartments, houses, and villas. Empowering
            landlords and tenants through smart, transparent property
            management.
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className="mt-14 flex flex-wrap items-center justify-center gap-8 md:gap-14 text-slate-600 dark:text-slate-400 text-sm md:text-base font-semibold"
          >
            <div className="flex items-center gap-3 hover:text-amber-500 transition-colors cursor-default">
              <div className="p-2.5 bg-white dark:bg-white/5 shadow-sm border border-slate-100 dark:border-white/10 rounded-full">
